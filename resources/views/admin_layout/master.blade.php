...
<head>
    ...
    <!-- Page Title  -->
    <title>305 Network - Admin Dashboard</title>
    <!-- StyleSheets  -->
                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    ...
                    <div class="nk-sidebar-brand">
                        <a href="{{ url('/admin-dashboard') }}" class="logo-link nk-sidebar-logo">
                            <!-- <h4 class="text-light">303 Network</h4> -->
                            <img class="logo-light logo-img" src="{{asset('img/site_logo.png')}}" srcset="{{asset('img/site_logo.png')}}" alt="logo">
                            <img class="logo-dark logo-img" src="{{asset('img/site_logo.png')}}" srcset="{{asset('img/site_logo.png')}}" alt="logo-dark">
                        </a>
                    </div>
                    ...
                    <div class="nk-sidebar-content">
                        ...
                        <ul class="nk-menu">
                            ...
                            <!-- <li class="nk-menu-item">
                                <a href="{{ url('admin-dashboard/locations') }}" class="nk-menu-link">
                            ...
                            <!-- Sports -->
                            <li class="nk-menu-item">
                                <a href="{{ url('admin-dashboard/sports') }}" class="nk-menu-link">
                                    <span class="nk-menu-icon">🏆</span>
                            ...
                            <!-- Positions -->
                            <li class="nk-menu-item">
                                <a href="{{ url('admin-dashboard/positions') }}" class="nk-menu-link">
                                    <span class="nk-menu-icon">🔢</span>
                            ...
                            <!-- Coaches -->
                            <li class="nk-menu-item">
                                <a href="{{ url('admin-dashboard/coaches') }}" class="nk-menu-link">
                                    <span class="nk-menu-icon">👨‍🏫</span>
                                    <span class="nk-menu-text">Coaches</span>
                                </a>
                            </li>

                            <!-- Players -->
                            <li class="nk-menu-item">
                                <a href="{{ url('admin-dashboard/players') }}" class="nk-menu-link">
                                    <span class="nk-menu-icon">🎮</span>
                            ...
                            <!-- Teams -->
                            <li class="nk-menu-item">
                                <a href="{{ url('admin-dashboard/teams') }}" class="nk-menu-link">
                                    <span class="nk-menu-icon">👥</span>
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="#" class="nk-menu-link nk-menu-toggle">
                                    <span class="nk-menu-icon">🏅</span>
                                    <span class="nk-menu-text">Matches</span>
                                </a>
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item">
                                        <a href="{{ url('admin-dashboard/matches/add') }}" class="nk-menu-link">
                                            <span class="nk-menu-text">Add Match</span>
                                        </a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="{{ url('admin-dashboard/matches') }}" class="nk-menu-link">
                                            <span class="nk-menu-text">List Matches</span>
                                        </a>
                                    </li>
                            ...
                            <!-- Games -->
                            <li class="nk-menu-item">
                                <a href="{{ url('admin-dashboard/news') }}" class="nk-menu-link">
                                    <span class="nk-menu-icon">📊</span>
                            ...
                            <li class="nk-menu-item has-sub">
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item">
                                        <a href="{{ url('admin-dashboard/pages/home') }}" class="nk-menu-link">
                                            <span class="nk-menu-text">Home Page</span>
                                        </a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="{{ url('admin-dashboard/pages/header') }}" class="nk-menu-link">
                                            <span class="nk-menu-text">Header Page</span>
                                        </a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="{{ url('admin-dashboard/pages/footer') }}" class="nk-menu-link">
                                            <span class="nk-menu-text">Footer Page</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> &copy; 2025 305 Network. </a>
                            </div>
