...
<div class="nk-block nk-block-lg">
    <div class="nk-block-head d-flex justify-content-between">
        <div class="nk-block-head-content">
            <h4 class="title nk-block-title">Add Player</h4>   
        </div>
    </div>
                ...
                <div class="row g-gs">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" class="form-control" id="jersey_number" name="jersey_number" value="{{ old('jersey_number') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" name="banner_image_video" id="banner_image_video" placeholder="Paste YouTube, Vimeo, or MP4 video URL here">
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <textarea name="athletic_info" class="description" id="athletic_info">{{ old('athletic_info') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" step="0.01" class="form-control" id="yard_dash_time" name="yard_dash_time" value="{{ old('yard_dash_time') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" step="0.01" class="form-control" id="vertical_jump" name="vertical_jump" value="{{ old('vertical_jump') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" step="0.01" class="form-control" id="shuttle_run_time" name="shuttle_run_time" value="{{ old('shuttle_run_time') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" class="form-control" id="squat_max" name="squat_max" value="{{ old('squat_max') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" class="form-control" id="deadlift_max" name="deadlift_max" value="{{ old('deadlift_max') }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <textarea name="season_stat" class="description" id="season_stat">{{ old('season_stat') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" class="form-control" id="games_played" name="games_played" value="{{ old('games_played') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="total_yards_passing" name="total_yards_passing" value="{{ old('total_yards_passing') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="total_yards_rushing" name="total_yards_rushing" value="{{ old('total_yards_rushing') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="total_yards_receiving" name="total_yards_receiving" value="{{ old('total_yards_receiving') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" class="form-control" id="touchdowns" name="touchdowns" value="{{ old('touchdowns') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" class="form-control" id="tackles" name="tackles" value="{{ old('tackles') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" class="form-control" id="interceptions" name="interceptions" value="{{ old('interceptions') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="kicking_stats" name="kicking_stats" value="{{ old('kicking_stats') }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <textarea name="academic_info" class="description" id="academic_info">{{ old('academic_info') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="sat_act_scores" name="sat_act_scores" value="{{ old('sat_act_scores') }}" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control description" id="academic_honors" name="academic_honors">{{ old('academic_honors') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control description" id="highlight_info" name="highlight_info">{{ old('highlight_info') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="game_footage_link" name="game_footage_link" value="{{ old('game_footage_link') }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="photo_gallery_link" name="photo_gallery_link" value="{{ old('photo_gallery_link') }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control description" id="award_info" name="award_info">{{ old('award_info') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="team_mvp_award" name="team_mvp_award" value="{{ old('team_mvp_award') }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="all_state_honors" name="all_state_honors" value="{{ old('all_state_honors') }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="athletic_camps_attended" name="athletic_camps_attended" value="{{ old('athletic_camps_attended') }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control description" id="recruting_info" name="recruting_info">{{ old('recruting_info') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="commitment_status" name="commitment_status" value="{{ old('commitment_status') }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="offers_received" name="offers_received" value="{{ old('offers_received') }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="preferred_colleges" name="preferred_colleges" value="{{ old('preferred_colleges') }}" />
                            </div>
                        </div>
